...
using deflix.movies.api.Services;
using deflix.movies.api.Types;
...
builder.Services.AddRefitClient<ISubscriptionsApi>()
    .ConfigureHttpClient((sp, httpClient) =>
    {
        var settings = sp.GetRequiredService<IOptions<AppSettings>>().Value.SubscriptionsApi;
