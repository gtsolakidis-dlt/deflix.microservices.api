...
using deflix.recommendations.api.Services;
using deflix.recommendations.api.Types;
...
builder.Services.AddRefitClient<IUserPreferencesApi>()
    .ConfigureHttpClient((sp, httpClient) =>
    {
        var settings = sp.GetRequiredService<IOptions<AppSettings>>().Value.UserPreferencesApi;
